...
public class ResourceUtil {
	...
	public static final String getQywxAccountId() {
		HttpSession session = ContextHolderUtils.getSession();
		if(session.getAttribute(WeiXinConstants.QYWX_ACCOUNT_ID)!=null){
			String qywxAccountId = (String) session.getAttribute(WeiXinConstants.QYWX_ACCOUNT_ID);
			return qywxAccountId;
		}else{
			return null;
		}
	}
