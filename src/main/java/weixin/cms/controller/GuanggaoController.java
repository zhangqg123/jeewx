...
public class GuanggaoController extends BaseController {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(GuanggaoController.class);
	 ...
	 * @return
	 */
	@RequestMapping(params = "guanggaoList")
	public ModelAndView guanggaoList(HttpServletRequest request) {
