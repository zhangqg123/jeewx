 ...
 */
@Entity
@Table(name = "weixin_cms_record", schema = "")
@DynamicUpdate(true)
@DynamicInsert(true)
@SuppressWarnings("serial")
public class CmsRecordEntity implements java.io.Serializable {
	/**主键*/
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  文章编号
	 */
	@Column(name ="ARTICLEID",nullable=true,length=100)
