...
// 			$.ajax({
// 				type : "POST",
// 				url : "reportDemoController.do?xiangzhenCount&reportType=line",
...
<script type="text/javascript">
	...
	function xiangzhen(){
		...
		$.ajax({
			type : "POST",
			url : "reportDemoController.do?xiangzhenCount&reportType=column&fromDate="+fromDate+"&toDate="+toDate,
			success : function(jsondata) {
...
// 			$.ajax({
// 				type : "POST",
// 				url : "reportDemoController.do?xiangzhenCount&reportType=pie",
// 				success : function(jsondata) {
// 					data = eval(jsondata);
// 					chart = new Highcharts.Chart({
// 						chart : {
	...
	<div id="logListtb" style="padding: 3px; height: 25px">
	    ...
	    <div name="searchColums" style="float: right; padding-right: 15px;">
	       <%--add-begin--Author:zhangguoming  Date:20140427 for：添加查询条件  操作时间--%>
	        ...
	        <a href="#" class="easyui-linkbutton" iconCls="icon-search" onclick="xiangzhen();">查询</a>
	    </div>
	</div>

<!-- <div style="width: 98%; height: 280px"> -->
<%-- 	<t:datagrid name="xiangzhenStatisticList" title="乡镇发文统计" actionUrl="reportDemoController.do?listAllxzStatisticByJdbc" idField="id" fit="true"> --%>
