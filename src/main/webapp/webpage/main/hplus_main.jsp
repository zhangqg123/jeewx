...
<head>
    ...
    <title>BOS  微信管家系统</title>

    <meta name="keywords" content="BOS  微信管家系统">
    <meta name="description" content="BOS  微信管家系统">
...
<div id="wrapper">
                ...
                <li class="nav-header" style="padding: 14px 25px;">
                    <div class="dropdown profile-element">
                        ...
                        <ul class="dropdown-menu animated fadeInRight m-t-xs">
                            ...
                            <li><a href="http://yun.bos.org" target="_blank">云应用中心</li>
                            <li class="divider"></li>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
                ...
                <div class="navbar-header" style="width: 40%;height: 60px;"><a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="#"><i class="fa fa-bars"></i> </a>
                    <form role="search" class="navbar-form-custom" method="post" action="search_results.html">
                        <div class="form-group" >
                            <input type="text" placeholder="BOS  微信管家系统" class="form-control" name="top-search" id="top-search">
                        </div>
                    </form>
                </div>
                   ...
                   <%--  <li class="dropdown">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-alerts">
                            ...
                            <li><a href="javascript:window.open('http://yun.bos.org')">云插件中心</a></li>
                        </ul>
                    </li>
                    <!-- //update-end--Author: chenj Date:20160726 for: TASK #1207 [改造]h+风格下，去掉logo下面的内容，迁移位置到右上角，主题位置 -->
        ...
        <div class="footer">
            <div class="pull-right">&copy; 版权所有 <span class="tip"><a href="http://www.bos.com" target="_blank" title="BOSBOS：微信公众账号开发平台">BOSBOS</a> (推荐谷歌浏览器，获得更快响应速度) 技术支持:<a href="http://www.bos.org" target="_blank" title="JEECG社区">JEECG 社区</a> </span>
            </div>
        </div>
    </div>
    <!--右侧部分结束-->
...
<script>
    ...
    function toJeecgYun(){
    	window.open("http://yun.bos.org","_blank");
    }
