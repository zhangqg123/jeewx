		...
		<table border="0" cellpadding="0" cellspacing="0">
			<tr style="height: 25px;" align="right">
				...
				<div id="layout_north_kzmbMenu" style="width: 100px; display: none;">
					...
					<div class="menu-sep"></div>	
					<div onclick="javascript:window.open('http://yun.bos.org')">云插件中心</div>
				</div>
...
<div align="center" style="color: #CC99FF; padding-top: 2px">&copy; 版权所有 <span class="tip"><a href="http://www.bos.com" title="BOS管家系统" target="_blank">BOS官网</a> (推荐谷歌浏览器，获得更快响应速度) &nbsp;&nbsp;技术支持: <a href="http://www.bos.org" title="BOS论坛" target="_blank">BOS技术论坛</a> </span></div>
</div>
