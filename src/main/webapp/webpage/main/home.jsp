<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
 <link type="text/css" rel="stylesheet" href="./plug-in/weixin/css/style.css">
     <div class="funcList" id="func">
            <ul class="list">
            	<a href="upload/files/demogroup.docx">
	            	<li>
	                    <img src="./plug-in/weixin/img/weixin.jpg" width="95" height="98">
	                    <h3>群发文章教程</h3>
	                    <p><font color="red">演示教程下载</font></p>
	                </li>
                </a>
                <a href="upload/files/demotransfer.docx">
	                <li>
...
<!--                 </li> -->
                ...
                <a href="upload/files/mobilework.mp4" target="_blank">
	                <li>
 	                    <img src="./plug-in/weixin/img/func05.jpg"> 
	                    <h3>手机发文演示视频</h3>
	                    <p><font color="red">演示视频下载</font></p>
	                </li>
                </a>
