...
<html>
 <head>
  ...
  function setimageTitle(obj){
	...
	$(function() {
		$('#columnId').combotree({
			url : 'cmsMenuController.do?treeMenu',
...
<!-- 						</tr> -->
     ...
     <td  class="value">    
      <input id="columnId" name="columnId" value="${cmsMenu.name}" />
      <span class="Validform_checktip">请选择上级菜单！</span>
						...
						<tr>
							...
							<td class="value">
								 <textarea name="content" id="content" style="width: 100%;height:300px">${cmsArticlePage.content}</textarea>
							    <script type="text/javascript">
