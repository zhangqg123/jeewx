  ...
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="weixinLinksucaiController.do?doUpdate" tiptype="1">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					...
					<tr>
						...
						<td class="value">
						    <t:dictSelect field="wxtype" typeGroupCode="wxtype" hasLabel="false" defaultVal="${weixinLinksucaiPage.wxtype}"></t:dictSelect>
							<span class="Validform_checktip"></span>
							<label class="Validform_label" style="display: none;">微信号类型</label>
						</td>
					</tr>
					<%--
					<tr>
