...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="privateWeixinLinksucaiList" checkbox="true" fitColumns="false" title="企业用用" actionUrl="weixinLinksucaiController.do?privateDatagrid" idField="id" fit="true" queryMode="group" sortOrder="desc" sortName="createDate">
   <t:dgCol title="主键"  field="id"  hidden="false"  queryMode="single" ></t:dgCol>
   <t:dgCol title="微信公众ID" field="accountid" hidden="false" ></t:dgCol>
   <t:dgCol title="应用名称"  field="name"    queryMode="single"  width="120"></t:dgCol>
