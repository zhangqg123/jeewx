...
<html>
 <head>
  ...
  $(function () {
      ...
      var url = 'weixinPhotoAlbumController.do?saveFiles',
          uploadButton = $('<button/>')
      ...
      $('#fileupload').fileupload({
  		...
  		if (d.success) {
      		...
      		$("#financeId").val(d.attributes.fileKey);
  		}else{
...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tFinanceController.do?save">
...
<%-- <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" callback="@Override uploadFile" action="weixinPhotoAlbumController.do?viewPhotos&type=table&isIframe&id=${albumId}"> --%>
<%-- 	<input id="albumId" name="albumId" type="hidden" value="${albumId}"> --%>
